...
class EmailVerificationView(generics.GenericAPIView):
    ...
    token_param = openapi.Parameter('token', openapi.IN_QUERY, description="verify token", type=openapi.TYPE_STRING)
    ...
    def get(self, request):
        ...
        try:
            ...
            return Response({"message": "Verify successfully"}, status=status.HTTP_200_OK)
...
class ResetPasswordView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        if user.exists():
            ...
            return Response({'message': "We've sent you an email to reset your password"}, status=status.HTTP_400_BAD_REQUEST)
